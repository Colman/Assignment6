...
{	
	...
	// creates a ray from point to the point light ptLight
	// return includes a ray (ray) and the distance from point to the point light
	//
	return distance;
}
